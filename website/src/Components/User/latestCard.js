    ...
    return (
      <>
        ...
        <div class="container-card">
          <div class="card image-wrapper bg-full bg-image bg-overlay bg-overlay-light-500 pb-15" style={{backgroundImage: `url(${BG22})`}}>
                  ...
                  <div class="col-lg-8 mt-lg-2">
                    <div class="row align-items-center counter-wrapper gy-6 text-center">
                      ...
                      <div class="col-md-4">
                        ...
                        <h3 class="counter" style={{visibility: "visible"}}>4x</h3>
                      ...
                      <div class="col-md-4">
                        ...
                        <h3 class="counter" style={{visibility: "visible"}}>99.7%</h3>
